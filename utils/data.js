...
'I wish I could increase my skill levels as easily as they can in The Sims.',
...
'I owed blockbuster late fees. My game plan of waiting them out worked, though.','The people who need to be loved the most are often very hard to love.',
...
'Some stranger remembers you for being kind to them when no one else was.','Most people aren\'t scared of being alone in the dark—they\'re scared of not being alone in the dark.',
...
'History classes are only going to get longer and harder as time goes on.','If 24-hour clocks started at 23:59 and counted down till 00:01, people might try getting more done.',
...
const getThoughtReactions = (usersList, int) => {
  ...
  for (let i = 0; i < int; i++) {
    results.push({
      ...
      username: getRandomArrItem(usersList),
    });
  }
  return results;
};
...
module.exports = { getRandomUsers, getRandomThoughts, getFriends };
